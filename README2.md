...
<p align="center">
  <img src="https://img.shields.io/badge/GIS-Professional%20Projects-2E86C1?style=for-the-badge" alt="Professional GIS Projects">
  <img src="https://img.shields.io/badge/Python-Spatial%20Data%20Science-3776AB?style=for-the-badge&logo=python&logoColor=white" alt="Python">
  <img src="https://img.shields.io/badge/GeoPandas-Spatial%20Analysis-139C5A?style=for-the-badge" alt="GeoPandas">
  <img src="https://img.shields.io/badge/Rasterio-Raster%20Processing-8E44AD?style=for-the-badge" alt="Rasterio">
</p>
...
Before starting the course, you can explore two **professional GIS projects** that I have already developed as part of this repository.

| 📄 Project | Description |
|---|---|
| **[1. Professional GIS Project](./1.pdf)** | A completed professional GIS analysis project demonstrating practical spatial data analysis, GIS workflows, mapping, and analytical interpretation. |
| **[2. Professional GIS Project](./2.pdf)** | A second completed professional GIS project demonstrating advanced GIS analysis, spatial workflows, visualisation, and interpretation. |

### 📚 Recommended

These projects provide examples of how the concepts and techniques covered in this course can be applied to **real-world GIS and spatial data science problems**.

> **💡 Tip:** Review these projects alongside the course to understand how individual GIS techniques can be combined into complete professional workflows.
...
| File | What it is |
|---|---|
| `1.pdf` | **Professional GIS Project 1.** A completed professional GIS analysis project developed as part of this repository. |
| `2.pdf` | **Professional GIS Project 2.** A completed professional GIS analysis project developed as part of this repository. |
...
* **Twelve deliberate data-quality defects** — invalid geometries, empty
  geometries, sentinel values, impossible dates, swapped coordinates,
  duplicate and orphan keys, inconsistent categories. All documented in
...
├── 1.pdf                            <- Professional GIS Project 1
├── 2.pdf                            <- Professional GIS Project 2
...
**One small recommendation:** if `1.pdf` and `2.pdf` have actual project titles, replacing **“Professional GIS Project 1/2”** with their real titles would make the repository look substantially more professional.
```
